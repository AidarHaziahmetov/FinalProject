    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_preview', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='', verbose_name='Превью')),
                ...
                ('images', models.ManyToManyField(blank=True, related_name='product', to='shop.productimage')),
            ],
            options={
                'verbose_name': 'Товар',
